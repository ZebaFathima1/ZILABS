  ...
  const content = (
    <div className="relative max-w-6xl mx-auto px-6">
      ...
      <div className="mt-12 grid lg:grid-cols-5 gap-8">
        ...
        >
          {contactQuery.isLoading ? (
            ...
            <div className="zv-glass-strong rounded-2xl p-6">
              <div className="font-display font-semibold text-white/90 text-lg mb-1">{BRAND.parent}</div>
        ...
        <motion.div
          initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }}
        ...
        >
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-sm text-white/50 mb-4">Fill out the form and we'll get back to you shortly.</p>
