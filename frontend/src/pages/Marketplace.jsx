...
const Marketplace = ({ isSection = false }) => {
                  ...
                  <TiltCard className="zv-card overflow-hidden h-full group">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        <button onClick={handleInquireClick} className="inline-flex items-center gap-1.5 text-sm text-cyan-300 hover:text-cyan-200">Inquire <ArrowUpRight size={14} /></button>
                      </div>
                    </div>
                  </TiltCard>
                </motion.div>
