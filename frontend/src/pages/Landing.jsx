        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              >
                <MagneticButton as={Link} to="/login" className="zv-btn-primary inline-flex items-center gap-2">
                  <Rocket size={18} /> Start Building
                </MagneticButton>
                <MagneticButton as={Link} to="/marketplace" className="zv-btn-ghost inline-flex items-center gap-2">
                  <Target size={18} /> Explore Programs
                </MagneticButton>
              </motion.div>
              <motion.div
          ...
          <div className="relative overflow-hidden rounded-3xl zv-glass-strong p-10 md:p-14 text-center">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <MagneticButton as={Link} to="/login" className="zv-btn-primary inline-flex items-center gap-2"><Rocket size={18} /> Start Building Now</MagneticButton>
                <MagneticButton as={Link} to="/marketplace" className="zv-btn-ghost inline-flex items-center gap-2"><Target size={18} /> Browse Projects</MagneticButton>
              </div>
            </div>
          </div>
        </div>
