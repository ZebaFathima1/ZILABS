// Static site content (not served by the API)
export const BRAND = {
...
export const FAQS = [
  ...
  { q: 'Who can join Zelvora Industry Labs?', a: 'Any student, fresher, or career switcher who wants to build a portfolio of real projects. No prior industry experience is required — tracks range from beginner to advanced across Web Development, Python Development, Java Development, Full Stack Development, Data Analytics, Artificial Intelligence, UI/UX Design, Cyber Security, Digital Marketing, and Cloud & DevOps.' },
  ...
  { q: 'What tracks are available?', a: 'We offer ten industry tracks: Web Development, Python Development, Java Development, Full Stack Development, Data Analytics, Artificial Intelligence, UI/UX Design, Cyber Security, Digital Marketing, and Cloud & DevOps. Each track includes structured project roadmaps, weekly milestones, mentor reviews, and a capstone project.' },
